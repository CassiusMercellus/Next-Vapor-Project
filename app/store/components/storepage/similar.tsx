        ...
        <>
            <div className="mt-14">
                <div className="flex justify-between">
                    <h1 className="mb-5 font-bold">Similar Titles</h1>
                    <div className="mb-5 border border-gray-500 rounded-md text-sm">
                ...
                <div className="flex justify-center flex-row items-center bg-gray-900 p-2 rounded-md">
                    ...
                    {randomGames.slice(currentIndex, currentIndex + visibleCount).map((game) => (
                        <div key={game.id} className="bg-gray-950 rounded-md w-1/3">
                            <div className="flex flex-col justify-between p-4 gap-4 h-72">
                                {game.images?.main ? (
                                <Image
                                ...
                                <div className="flex flex-col">
                                    ...
                                    {game.title.length > 13 ? game.title.slice(0, 10) + "..." : game.title}
                                    </h2>
