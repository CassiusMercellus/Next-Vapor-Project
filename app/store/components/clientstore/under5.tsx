...
export default function Under5() {
    ...
    const under10 = games.filter(
        (game) => parseInt(game.packages?.Game?.Price) <= 10 || parseInt(game.packages?.Game?.Price) === 0
      );
      ...
      const nextSlide = () => {
        if (currentIndex < under10.length - 1) {
        ...
        <>
            <div className="bg-slate-900 pt-20 pb-5 px-40">
                <div className="flex justify-between">
                    <h1 className="mb-6 font-bold">Under $10</h1>
                ...
                <div className="flex justify-center flex-row items-center bg-gray-900 p-2 rounded-md">
                    ...
                    {under10.slice(currentIndex, currentIndex + itemsPerPage).map((game) => (
                                            <div key={currentIndex} className="bg-gray-950 rounded-md w-1/3">
                                                ...
                                                <a href={`/store/gamepage/${game.id}`}><h2 className="text-3xl text-white font-bold">
                                                    ...
                                                    <>
                                                        ...
                                                        <p className="text-white font-bold py-2">${game.packages?.Game?.Price}</p>
                                                        ) : (
                                                        <>
                                    ...
                                    <button
                                    onClick={nextSlide}
                                    disabled={currentIndex + itemsPerPage >= under10.length}
            ...
            <div className="py-2 pb-20 bg-slate-900">
                <div className="flex justify-center gap-2">
                    {under10.slice(0, under10.length - 2).map((_, index) => (
                        <div
                        key={index}
